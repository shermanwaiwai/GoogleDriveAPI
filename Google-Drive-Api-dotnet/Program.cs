...
namespace Daimto.Drive.api
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            String CLIENT_SECRET = "yoursecretid";      
            ...
            try
            {
                ...
                string Q = "title = 'myfolder' and mimeType = 'application/vnd.google-apps.folder'";
                ...
                if (_Files.Count != 0)
                {
                    ...
                    File newFile = DaimtoGoogleDriveHelper.uploadFile(service, @"c:\demo\1.pdf", directoryId);
                    // Update The file
                    File UpdatedFile = DaimtoGoogleDriveHelper.updateFile(service, @"c:\demo\1.pdf", directoryId, newFile.Id);
                    // Download the file
                    DaimtoGoogleDriveHelper.downloadFile(service, newFile, @"c:\demo\demo\1.pdf");
                    // delete The file
